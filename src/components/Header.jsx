  ...
  return (
    <div className="container flex flex-wrap justify-between items-center gap-10">
      ...
      <div className="relative">
        ...
        <div className="hidden lg:block absolute top-40 right-0 bg-white rounded-sm p-3 ">
          <span className="text-pri font-bold px-2 text-xl">24/7</span>
          services
        </div>
        <div className="hidden mf:block absolute bottom-10 -left-20 bg-white rounded-sm px-5 py-2 ">
